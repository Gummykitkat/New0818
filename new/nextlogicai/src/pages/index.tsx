      ...
      <section className="hero">
        <div className="container">
          <h1>
            ...
            <span className="highlight">Every Industry</span>
          </h1>
          <p>
            We implement cutting-edge artificial intelligence services that
            transform how businesses operate, compete, and grow across
            healthcare, finance, retail, manufacturing, and many other
            industries.
          </p>
